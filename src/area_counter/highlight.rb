...
module BACommunity
  module AreaCounter
    ...
    #
    # Цвета — смысловые из дизайн-кода B&A: зелёный «успех», оранжевый «внимание».
    # Габариты этажей — тонкой линией, контуры сечения — толстой: замкнутые
    # зелёным, разошедшиеся куски оранжевым. По ним видно, где именно сечение
    # не сошлось и что в него не попало.
    module Highlight

      OK_COLOR      = Sketchup::Color.new(47, 133, 90)    # #2F855A — «успех» по дизайн-коду B&A
      PROBLEM_COLOR = Sketchup::Color.new(221, 138, 32)   # #DD8A20 — «внимание»
